...
class ComandoJogo(Enum):
    """Classe ComandoJogo representa um comando do jogo, que pode ser utilizado para controlar o ambiente do jogo. Esta classe é utilizada para representar os comandos que o agente pode executar no ambiente do jogo."""
    PROCURAR = 1
    APROXIMAR = 2
    OBSERVAR = 3
    FOROGRAFAR = 4
